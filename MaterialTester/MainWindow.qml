	...
	Sidebar {
		...
		SidebarItem {
			...
			model: [
				...
				{text : "ToggleButtonGroup", onClicked: function(){ showcaseLoader.sourceComponent = toggleButtonGroupShowcase }},
				{text : "SpinBox", onClicked: function(){ showcaseLoader.sourceComponent = spinBoxShowcase }}
			];
		}
